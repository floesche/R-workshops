...
In that folder, I have already created a modified template, where I basically copied the content of FinalMD.tex and pasted it within the `\begin{document}... \end{document}`.
