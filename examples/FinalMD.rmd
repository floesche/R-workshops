...
In that folder, I have already created a modified template, where I basically copied the content of FinalMD.tex (starting from Header 1) and pasted it within the `\begin{document}... \end{document}`.
