...
% I had to add the following commands: a pandoc command which was causing problems when using \tightlist (solution found here: https://github.com/jgm/pandoc-templates/blob/master/default.latex); this command is also found in the LaTex output created by RStudio.
