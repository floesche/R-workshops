...
1. you: 
    ...
    - save file
    - tell pandoc generate a pdf
2. pandoc: 
    - read Markdown -[filter]-> LaTeX
    - start pdflatex
3. pdflatex: 
    - read LaTeX -> pdf
4. you:
...
see [example/apa-simple.template](../example/apa-simple.template) and [example/exampleArticle.Rmd](../example/exampleArticle.Rmd)
...
see [example/apa.template](../example/apa.template) and [example/exampleArticle.Rmd](../example/exampleArticle.Rmd)
